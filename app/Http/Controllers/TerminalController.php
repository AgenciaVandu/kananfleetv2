...
class TerminalController extends Controller
{
    ...
    public function payment(){
        ...
        function calculateOrderAmount(array $items): int {
            ...
            $conversion = Http::get("https://www.banxico.org.mx/SieAPIRest/service/v1/series/SF43784/datos/".now()->format('Y-m-d')."/".now()->format('Y-m-d')."/?token=570f63e4e5caaa0a8848bcc07e31ba64774bfb9838a9940cba6b5003cb6bcfc8",['verify' => false]);//SF43784
