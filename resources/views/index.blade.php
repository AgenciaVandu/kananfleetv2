                ...
                <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="{{ asset('/img/banners/inicio/2.png') }}" loading="lazy" class="d-block w-100" alt="Kananfleet">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('/img/banners/inicio/3.png') }}" loading="lazy" class="d-block w-100" alt="Kananfleet">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('/img/banners/inicio/4.png') }}" loading="lazy" class="d-block w-100" alt="Kananfleet">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-azul">
        <div class="container text-center">
            <h3 class="source-bold pb-4 pt-5">¿Por qué elegir Kananfleet® como su administrador de activos?</h4>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/dtMnCr9eT5I?si=qt5t55xhKyQ0i2du" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
